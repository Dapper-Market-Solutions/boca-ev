...
const MODELS = [
  {
    ...
    // Range pending client confirmation — omitted intentionally
    specs: {
      Seats: '4 · Forward-Facing',
      Motor: '48V 5KW AC',
      'Top Speed': '20 MPH · 25 MPH LSV upgrade',
      Battery: '48V 105Ah Lithium · 150Ah upgrade',
      'Charge Time': '6 hours',
      Weight: '1,213 lbs',
      Dimensions: '118" L × 51" W × 76" H',
      Tires: '215/35-R12 @ 25 PSI',
      Controller: '400 AMP',
      Suspension: 'Independent Coil Spring (front) / Single Leaf + Hydraulic (rear)',
      Brakes: 'Four-Wheel Disc',
      Steering: 'Rack & Pinion',
      Display: '10.1" Touchscreen',
    },
    features: [
      'Removable Rear Storage Trunk',
      'Running Boards',
      'LED Underglow + Customizable Light-Up Running Boards',
      'Floating Pedals + Adjustable Steering Wheel',
      'Keyless Start + Wireless Phone Charging',
      'Apple CarPlay & Android Auto',
      'Backup Camera + Turn-Signal Side Mirrors',
      'DOT-Rated Flip-Down Windshield',
    ],
  },
  {
    ...
    specs: {
      ...
      'Charge Time': '6 hours',
      Weight: '1,127 lbs',
      Dimensions: '118" L × 51" W × 80" H',
      Tires: '225/50-R14 @ 25 PSI',
      Controller: '400 AMP',
      Suspension: 'Independent Leaf Spring (front) / Coil Hydraulic Shock (rear)',
      Brakes: 'Four-Wheel Disc',
      Steering: 'Rack & Pinion',
      Display: '10.1" Touchscreen',
    },
  ...
  },
  {
    ...
    // Range pending client confirmation — omitted intentionally
    specs: {
      Seats: '6 · 4 Forward + 2 Rear-Facing',
      Motor: '48V 5KW AC',
      'Top Speed': '20 MPH · 25 MPH LSV upgrade',
      Battery: '48V 105Ah Lithium · 150Ah upgrade',
      'Charge Time': '6 hours',
      Weight: '1,317 lbs',
      Dimensions: '146" L × 53" W × 76.5" H',
      Tires: '22 × 10-14 @ 20 PSI',
      Controller: '350 AMP',
      Suspension: 'Dual A-Arm Wishbone (front) / Trailing Arm Independent (rear)',
      Brakes: 'Four-Wheel Disc',
      Steering: 'Rack & Pinion',
      Display: '10.1" Touchscreen',
    },
    features: [
      '2 Rear-Facing Seats + Captain’s Chairs',
      'Front Brushguard',
      'Wireless Phone Charging',
      'Apple CarPlay & Android Auto',
      'Backup Camera + Turn-Signal Side Mirrors',
      'DOT-Rated Flip-Down Windshield',
      'Two Lockable Glove Boxes',
      'Front Basket (Special Order)',
    ],
  },
  {
  ...
  },
  {
    ...
    // Range pending client confirmation — omitted intentionally
    specs: {
      Seats: '4 · 2 Forward + 2 Rear-Facing',
      Motor: '48V 5KW AC',
      'Top Speed': '20 MPH · 25 MPH LSV upgrade',
      Battery: '48V 105Ah Lithium · 150Ah upgrade',
      'Charge Time': '6 hours',
      Weight: '1,042 lbs',
      Dimensions: '116" L × 53" W × 77" H',
      Tires: '215/35-R12 @ 20 PSI',
      Controller: '400 AMP',
      Suspension: 'Dual A-Arm Wishbone (front) / Trailing Arm Independent (rear)',
      Brakes: 'Four-Wheel Disc',
      Steering: 'Rack & Pinion',
  ...
  },
  {
    ...
    specs: {
      ...
      'Charge Time': '6 hours',
      Weight: '1,191 lbs',
      Dimensions: '95" L × 48" W × 74" H',
      Tires: '215 × 35-12 @ 20 PSI',
      Controller: '350 AMP',
      Suspension: 'Dual A-Arm Wishbone (front) / Trailing Arm Independent (rear)',
      Brakes: 'Four-Wheel Disc',
      Steering: 'Rack & Pinion',
...
const PILLARS = [
  ...
  },
  {
    ...
    description: 'All-electric, whisper-quiet powertrains driven by a 48V 5KW AC motor — clean operation with no fuel, no fumes, and minimal upkeep.',
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.2">
